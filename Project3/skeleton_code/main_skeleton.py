...
model_type = 1
model = Unet(3, 22) if model_type == 0 else UNetWithResnet50Encoder(22)
###############################################################################
...
pretrained_path = "../trained_model/UNet_trained_model.pth" if model_type == 0 else "../trained_model/resnet_encoder_unet.pth"
